...
$(function () {
    ...
    $('.post p').click(function () {
        ...
        var collect = [];
        var arr = $('.clicked', window.parent.document).data('url');
...
!(function () {
  function t() {}function e(t) {
    var e = t.length - 1;return function () {
      var n = kt.call(arguments, 0, e),
          i = kt.call(arguments, e);return t.apply(this, n.concat([i]));
    };
  }function n(t) {
    return e(function (e, n) {
      "function" != typeof e && (e = jt(e));var i = function i(t) {
        return e.apply(t, [t].concat(n));
      };return t.call(this, i);
    });
  }function i(t) {
    var e = kt.call(arguments, 1);return function () {
    ...
    function n(t) {
      var e, n;return t && t.nodeType ? (e = Dt(t).children(".mq-root-block").attr(xt), n = e && St.byId[e].controller, n ? s[n.KIND_OF_MQ](n) : null) : null;
    }function i(t, e) {
      var n, i, r;e && e.handlers && (e.handlers = { fns: e.handlers, APIClasses: s });for (n in e) e.hasOwnProperty(n) && (i = e[n], r = Ft[n], t[n] = r ? r(i) : i);
    }var s, r, o;if (!(e >= g && b >= e)) throw "Only interface versions between " + g + " and " + b + " supported. You specified: " + e;s = {}, n.L = Tt, n.R = Ct, n.config = function (t) {
      return i(Bt.p, t), this;
    }, n.registerEmbed = function (t, e) {
      if (!/^[a-z][a-z0-9]*$/i.test(t)) throw "Embed name must start with letter and be only letters and digits";Nt[t] = e;
      ...
      t.init = function (t) {
        ...
        var e,
            n = this.__controller,
            i = n.root,
            s = n.container;n.createTextarea(), e = s.addClass(t).contents().detach(), i.jQ = Dt('<span class="mq-root-block"/>').attr(xt, i.id).appendTo(s), this.latex(e.text()), this.revert = function () {
      ...
      e.__mathquillify = function () {
        ...
        var e,
            ...
            i = n.cursor;return (/^\\[a-z]+$/i.test(t) ? (t = t.slice(1), e = Et[t], e && (t = e(t), i.selection && t.replaces(i.replaceSelection()), t.createLeftOf(i.show()), this.__controller.scrollHoriz())) : i.parent.write(i, t), n.blurred && i.hide().parent.blur(), this
        );
      }, e.select = function () {
        var t = this.__controller;for (t.notify("move").cursor.insAtRightEnd(t.root); t.cursor[Tt];) t.selectLeft();return this;
        ...
        var n;for (e = e.replace(/^\s+|\s+$/g, "").split(/\s+/), n = 0; n < e.length; n += 1) this.__controller.keystroke(e[n], { preventDefault: t });return this;
      }, e.typedText = function (t) {
        for (var e = 0; e < t.length; e += 1) this.__controller.typedText(t.charAt(e));return this;
      }, e.dropEmbedded = function (t, e, n) {
        var i,
            s = t - Dt(window).scrollLeft(),
            r = e - Dt(window).scrollTop(),
            o = document.elementFromPoint(s, r);this.__controller.seek(Dt(o), t, e), i = gt().setOptions(n), i.createLeftOf(this.__controller.cursor);
      };
    }), n.EditableField = function () {
      throw "wtf don't call me, I'm 'abstract'";
    }, n.EditableField.prototype = s.EditableField.prototype;for (o in Mt) (function (t, i) {
      var r = s[t] = i(s);n[t] = function (i, s) {
        var o,
            a = n(i);return a instanceof r || !i || !i.nodeType ? a : (o = zt(r.RootBlock(), Dt(i), Bt()), o.KIND_OF_MQ = t, r(o).__mathquillify(s, e));
      }, n[t].prototype = r.prototype;
    })(o, Mt[o]);return n;
  }function u(t) {
    var e,
        n = "moveOutOf deleteOutOf selectOutOf upOutOf downOutOf".split(" ");for (e = 0; e < n.length; e += 1) (function (e) {
      t[e] = function (t) {
        this.controller.handle(e, t);
      };
    })(n[e]);t.reflow = function () {
    ...
    var e = this.parent,
        n = t;do {
      if (n[Ct]) return t.insLeftOf(e);n = n.parent.parent;
    } while (n !== e);t.insRightOf(e);
  }function p(t, e) {
    t.jQadd = function () {
      ...
      var t = this.contentjQ.outerHeight() / parseFloat(this.contentjQ.css("fontSize"));Y(this.delimjQs, yt(1 + .2 * (t - 1), 1.2), 1.2 * t);
    };
  }function d(t, e) {
    var e = e || t,
        n = pt[t],
        s = pt[e];At[t] = i(ft, Tt, t, n, e, s), At[n] = i(ft, Ct, t, n, e, s);
  }var m,
      g,
      b,
      v,
    ...
    function i(t) {
      ...
      function c() {
        var t = new u();return s(t.init) && t.init.apply(t, arguments), t;
      }function u() {}var h, f, p;return l === n && (l = a, a = Object), c.Bare = u, h = r[t] = a[t], f = u[t] = c[t] = c.p = new r(), f.constructor = c, c.mixin = function (e) {
        return u[t] = c[t] = o(c, e)[t], c;
      }, (c.open = function (t) {
        if ((p = {}, s(t) ? p = t.call(c, f, h, c, a) : i(t) && (p = t), i(p))) for (var n in p) e.call(p, n) && (f[n] = p[n]);return s(f.init) || (f.init = a), c;
      })(l);
    };
    ...
    function e() {
      return i += 1;
    }t[Tt] = 0, t[Ct] = 0, t.parent = 0;var i = 0;this.byId = {}, t.init = function () {
      ...
      function e(t) {
        var n, i;for (t.getAttribute && (n = t.getAttribute("mathquill-command-id"), i = t.getAttribute("mathquill-block-id"), n && St.byId[n].jQadd(t), i && St.byId[i].jQadd(t)), t = t.firstChild; t; t = t.nextSibling) e(t);
      }var n;for (t = Dt(t || this.html()), n = 0; n < t.length; n += 1) e(t[n]);return t;
    }, t.createDir = function (t, e) {
      r(t);var n = this;return n.jQize(), n.jQ.insDirOf(t, e.jQ), e[t] = n.adopt(e.parent, e[Tt], e[Ct]), n;
    }, t.createLeftOf = function (t) {
      return this.createDir(Tt, t);
    }, t.selectChildren = function (t, e) {
      return It(t, e);
    }, t.bubble = n(function (t) {
      var e, n;for (e = this; e && (n = t(e), n !== !1); e = e.parent);return this;
      ...
      var t = this.children();return t.each.apply(t, arguments), this;
    ...
    t.init = function (t, e, n) {
      if ((n === m && (n = Tt), r(n), s("no half-empty fragments", !t == !e), this.ends = {}, t)) {
        s("withDir is passed to Fragment", t instanceof St), s("oppDir is passed to Fragment", e instanceof St), s("withDir and oppDir have the same parent", t.parent === e.parent), this.ends[n] = t, this.ends[-n] = e;var i = this.fold([], function (t, e) {
      ...
      var i, s, r;return o(t, e, n), i = this, i.disowned = !1, (s = i.ends[Tt]) ? (r = i.ends[Ct], e || (t.ends[Tt] = s), n ? n[Tt] = r : t.ends[Ct] = r, i.ends[Ct][Ct] = n, i.each(function (n) {
      ...
      var t,
          e,
          n = this,
          i = n.ends[Tt];return !i || n.disowned ? n : (n.disowned = !0, t = n.ends[Ct], e = i.parent, o(e, i[Tt], i), o(e, t, t[Ct]), i[Tt] ? i[Tt][Ct] = t[Ct] : e.ends[Tt] = t[Ct], t[Ct] ? t[Ct][Tt] = i[Tt] : e.ends[Ct] = i[Tt], n);
    }, t.remove = function () {
      return this.jQ.remove(), this.each("postOrder", "dispose"), this.disown();
    }, t.each = n(function (t) {
      var e,
          n = this,
          i = n.ends[Tt];if (!i) return n;for (; i !== n.ends[Ct][Ct] && (e = t(i), e !== !1); i = i[Ct]);return n;
    }), t.fold = function (t, e) {
      ...
      Rt = Qt(_t, function (t) {
    t.init = function (t, e) {
      this.parent = t, this.options = e;var n = this.jQ = this._jQ = Dt('<span class="mq-cursor">&#8203;</span>');this.blink = function () {
      ...
      var s = this.parent;this.parent = e, this[t] = n, this[-t] = i, s !== e && s.blur && s.blur();
    }, t.insDirOf = function (t, e) {
      ...
      var n,
          i,
          s = this;s.upDownCache[t.id] = _t.copy(s), n = s.upDownCache[e.id], n ? n[Ct] ? s.insLeftOf(n[Ct]) : s.insAtRightEnd(n.parent) : (i = s.offset().left, e.seek(i, s));
    }, t.offset = function () {
      var t = this,
          e = t.jQ.removeClass("mq-cursor").offset();return t.jQ.addClass("mq-cursor"), e;
    }, t.unwrapGramp = function () {
      var t = this.parent.parent,
          e = t.parent,
          n = t[Ct],
          i = this,
          s = t[Tt];if ((t.disown().eachChild(function (i) {
        ...
        if ((this.parent = this.parent[Ct], !this.parent)) {
          this[Ct] = t[Ct], this.parent = e;break;
      ...
      var t,
          ...
          n = e.ancestors = {};for (t = e; t.parent; t = t.parent) n[t.parent.id] = t;
      ...
      var t,
          ...
          o,
          a,
          l = this.anticursor;if (this[Tt] === l[Tt] && this.parent === l.parent) return !1;for (t = this; t.parent; t = t.parent) if (t.parent.id in l.ancestors) {
        e = t.parent;break;
      ...
      var t = this.selection;return t && (this[Tt] = t.ends[Tt][Tt], this[Ct] = t.ends[Ct][Ct], delete this.selection), t;
    };
  }),
    ...
    t.init = function (t, e, n) {
      ...
      var n,
          i = this.options.handlers;i && i.fns[t] && (n = i.APIClasses[this.KIND_OF_MQ](this), e === Tt || e === Ct ? i.fns[t](e, n) : i.fns[t](n));
    };var e = [];this.onNotify = function (t) {
      e.push(t);
    }, t.notify = function () {
      for (var t = 0; t < e.length; t += 1) e[t].apply(this.cursor, arguments);return this;
    };
  }),
      Mt = {},
      Bt = Qt(),
      Ft = {},
      $t = Qt(),
      Nt = {};l.prototype = $t.p, l.interfaceVersion = function (t) {
    if (1 !== t) throw "Only interface version 1 supported. You specified: " + t;return a = function () {
    ...
    function i(t, e) {
    ...
    }var r, o, a, l, c, u, h, f, p, d, m, g, b;t.init = function (t) {
      this._ = t;
    }, t.parse = function (t) {
      function e(t, e) {
        return e;
      ...
      s("or is passed a parser", t instanceof n);var e = this;return n(function (n, i, s) {
        function r(e) {
          return t._(n, i, s);
        }return e._(n, i, r);
      });
    }, t.then = function (t) {
      var e = this;return n(function (i, r, o) {
        function a(e, i) {
          var a = t instanceof n ? t : t(i);return s("a parser is returned", a instanceof n), a._(e, r, o);
        }return e._(i, a, o);
      });
    }, t.many = function () {
      var t = this;return n(function (e, n, i) {
        function s(t, n) {
          return e = t, o.push(n), !0;
        }function r() {
          return !1;
        }for (var o = []; t._(e, s, r););return n(e, o);
      });
    }, t.times = function (t, e) {
      arguments.length < 2 && (e = t);var i = this;return n(function (n, s, r) {
        function o(t, e) {
          ...
          return !1;
            ...
            u,
            h = [],
            f = !0;for (u = 0; t > u; u += 1) if ((f = i._(n, o, a), !f)) return r(n, c);for (; e > u && f; u += 1) f = i._(n, o, l);return s(n, h);
      });
    }, t.result = function (t) {
      ...
      var e = this;return e.times(t).then(function (t) {
      ...
      var e = t.length,
          i = "expected '" + t + "'";return n(function (n, s, r) {
        var o = n.slice(0, e);return o === t ? s(n.slice(e), o) : r(n, i);
      });
    }, o = this.regex = function (t) {
      s("regexp parser is anchored", "^" === t.toString().charAt(1));var e = "expected " + t;return n(function (n, i, s) {
        var r,
            o = t.exec(n);return o ? (r = o[0], i(n.slice(r.length), r)) : s(n, e);
      });
    ...
    function e(t) {
      var e,
          i = t.which || t.keyCode,
          s = n[i],
          r = [];return t.ctrlKey && r.push("Ctrl"), t.originalEvent && t.originalEvent.metaKey && r.push("Meta"), t.altKey && r.push("Alt"), t.shiftKey && r.push("Shift"), e = s || String.fromCharCode(i), r.length || s ? (r.push(e), r.join("-")) : e;
    }var n = { 8: "Backspace", 9: "Tab", 10: "Enter", 13: "Enter", 16: "Shift", 17: "Control", 18: "Alt", 20: "CapsLock", 27: "Esc", 32: "Spacebar", 33: "PageUp", 34: "PageDown", 35: "End", 36: "Home", 37: "Left", 38: "Up", 39: "Right", 40: "Down", 45: "Insert", 46: "Del", 144: "NumLock" };return function (n, i) {
      function s(t) {
        q = t, clearTimeout(d), d = setTimeout(t);
      }function r(e) {
        q(), q = t, clearTimeout(d), v.val(e), e && v[0].select && v[0].select(), m = !!e;
      }function o() {
        var t = v[0];return "selectionStart" in t ? t.selectionStart !== t.selectionEnd : !1;
      }function a() {
        i.keystroke(e(g), g);
      }function l(e) {
        ...
        if (!o()) {
          var t = v.val();1 === t.length ? (v.val(""), i.typedText(t)) : t && v[0].select && v[0].select();
        }
      }function h() {
        g = b = null;
      }function f(t) {
        ...
        var t = v.val();v.val(""), t && i.paste(t);
          ...
          v = wt(n),
          w = wt(i.container || v),
          q = t;return w.bind("keydown keypress input keyup focusout paste", function (t) {
        q(t);
    ...
    t.focusBlurEvents = function () {
      function t() {
        ...
        r.hide().parent.blur(), i.container.removeClass("mq-focused"), Dt(window).off("blur", t);
          ...
          i = this,
          s = i.root,
          r = i.cursor;i.textarea.focus(function () {
    ...
    t.keystroke = function (t, e, n) {
      var i = n.cursor;switch (t) {case "Ctrl-Shift-Backspace":case "Ctrl-Backspace":
          n.ctrlDeleteDir(Tt);break;case "Shift-Backspace":case "Backspace":
          n.backspace();break;case "Esc":case "Tab":
          return void n.escapeDir(Ct, t, e);case "Shift-Tab":case "Shift-Esc":
          return void n.escapeDir(Tt, t, e);case "End":
          n.notify("move").cursor.insAtRightEnd(i.parent);break;case "Ctrl-End":
          n.notify("move").cursor.insAtRightEnd(n.root);break;case "Shift-End":
          for (; i[Ct];) n.selectRight();break;case "Ctrl-Shift-End":
          for (; i[Ct] || i.parent !== n.root;) n.selectRight();break;case "Home":
          n.notify("move").cursor.insAtLeftEnd(i.parent);break;case "Ctrl-Home":
          n.notify("move").cursor.insAtLeftEnd(n.root);break;case "Shift-Home":
          for (; i[Tt];) n.selectLeft();break;case "Ctrl-Shift-Home":
          for (; i[Tt] || i.parent !== n.root;) n.selectLeft();break;case "Left":
          n.moveLeft();break;case "Shift-Left":
          n.selectLeft();break;case "Ctrl-Left":
          break;case "Right":
          n.moveRight();break;case "Shift-Right":
          n.selectRight();break;case "Ctrl-Right":
          break;case "Up":
          n.moveUp();break;case "Down":
          n.moveDown();break;case "Shift-Up":
          if (i[Tt]) for (; i[Tt];) n.selectLeft();else n.selectLeft();case "Shift-Down":
          if (i[Ct]) for (; i[Ct];) n.selectRight();else n.selectRight();case "Ctrl-Up":
          break;case "Ctrl-Down":
          break;case "Ctrl-Shift-Del":case "Ctrl-Del":
          n.ctrlDeleteDir(Ct);break;case "Shift-Del":case "Del":
          n.deleteForward();break;case "Meta-A":case "Ctrl-A":
          for (n.notify("move").cursor.insAtRightEnd(n.root); i[Tt];) n.selectLeft();break;default:
          return;}e.preventDefault(), n.scrollHoriz();
    ...
    function e(t, e) {
      var n = t.notify("upDown").cursor,
          i = e + "Into",
          s = e + "OutOf";return n[Ct][i] ? n.insAtLeftEnd(n[Ct][i]) : n[Tt][i] ? n.insAtRightEnd(n[Tt][i]) : n.parent.bubble(function (t) {
        var e = t[s];return e && ("function" == typeof e && (e = t[s](n)), e instanceof St && n.jumpUpDown(t, e), e !== !0) ? !1 : void 0;
      }), t;
    }this.onNotify(function (t) {
      ("move" === t || "upDown" === t) && this.show().clearSelection();
    }), t.escapeDir = function (t, e, n) {
      r(t);var i = this.cursor;return i.parent !== this.root && n.preventDefault(), i.parent !== this.root ? (i.parent.moveOutOf(t, i), this.notify("move")) : void 0;
    }, Ft.leftRightIntoCmdGoes = function (t) {
      if (t && "up" !== t && "down" !== t) throw '"up" or "down" required for leftRightIntoCmdGoes option, got "' + t + '"';return t;
    }, t.moveDir = function (t) {
      r(t);var e = this.cursor,
          n = e.options.leftRightIntoCmdGoes;return e.selection ? e.insDirOf(t, e.selection.ends[t]) : e[t] ? e[t].moveTowards(t, e, n) : e.parent.moveOutOf(t, e, n), this.notify("move");
    }, t.moveLeft = function () {
      ...
      var e, n;return r(t), e = this.cursor, n = e.selection, this.notify("edit"), n || (e[t] ? e[t].deleteTowards(t, e) : e.parent.deleteOutOf(t, e)), e[Tt].siblingDeleted && e[Tt].siblingDeleted(e.options, Ct), e[Ct].siblingDeleted && e[Ct].siblingDeleted(e.options, Tt), e.parent.bubble("reflow"), this;
    }, t.ctrlDeleteDir = function (t) {
      r(t);var e = this.cursor;return !e[Tt] || e.selection ? ctrlr.deleteDir() : (this.notify("edit"), Lt(e.parent.ends[Tt], e[Tt]).remove(), e.insAtDirEnd(Tt, e.parent), e[Tt].siblingDeleted && e[Tt].siblingDeleted(e.options, Ct), e[Ct].siblingDeleted && e[Ct].siblingDeleted(e.options, Tt), e.parent.bubble("reflow"), this);
      ...
      var e,
          ...
          i = n.selection;r(t), n.anticursor || n.startSelection(), e = n[t], e ? i && i.ends[t] === e && n.anticursor[-t] !== e ? e.unselectInto(t, n) : e.selectTowards(t, n) : n.parent.selectOutOf(t, n), n.clearSelection(), n.select() || n.show();
    ...
    function t(t) {
      var e = T();return t.adopt(e, 0, 0), e;
    }function e(t) {
      var e,
          n = t[0] || T();for (e = 1; e < t.length; e += 1) t[e].children().adopt(n, n.ends[Ct], 0);return n;
    }var n = w.string,
        i = w.regex,
        s = w.letter,
        r = w.any,
      ...
      var e = Et[t];return e ? e(t).parser() : l("unknown command: \\" + t);
    }),
        f = h.or(c).or(u),
        p = n("{").then(function () {
      return m;
      ...
      return "]" !== t.join("latex") ? a(t) : l();
        ...
        b = m;return b.block = d, b.optBlock = g, b;
  })(), zt.open(function (t, e) {
    t.exportLatex = function () {
      ...
      var e,
          ...
          r = w.all,
          o = w.eof,
          a = x.skip(o).or(r.result(!1)).parse(t);i.eachChild("postOrder", "dispose"), i.ends[Tt] = i.ends[Ct] = 0, a && a.children().adopt(i, 0, 0), e = i.jQ, a ? (n = a.join("html"), e.html(n), i.jQize(e.children()), i.finalizeInsert(s.options)) : e.empty(), delete s.selection, s.insAtRightEnd(i);
      ...
      var e,
          ...
          u,
          h = this.root,
          f = this.cursor;if ((h.jQ.children().slice(1).remove(), h.eachChild("postOrder", "dispose"), h.ends[Tt] = h.ends[Ct] = 0, delete f.selection, f.show().insAtRightEnd(h), e = w.regex, n = w.string, i = w.eof, s = w.all, r = n("$").then(x).skip(n("$").or(i)).map(function (t) {
        var e,
            n = S(f);return n.createBlocks(), e = n.ends[Tt], t.children().adopt(e, 0, 0), n;
      }), o = n("\\$").result("$"), a = o.or(e(/^[^$]/)).map(j), l = r.or(a).many(), c = l.skip(i).or(s.result(!1)).parse(t))) {
        for (u = 0; u < c.length; u += 1) c[u].adopt(h, h.ends[Ct], 0);h.jQize().appendTo(h.jQ), h.finalizeInsert(f.options);
      }
    };
  }), zt.open(function (e) {
    e.delegateMouseEvents = function () {
      var e = this.root.jQ;this.container.bind("mousedown.mathquill", function (n) {
        function i(t) {
          o = Dt(t.target);
        }function s(t) {
          ...
          u.blink = h, u.selection || (c.editable ? u.show() : f.detach()), a.unbind("mousemove", i), Dt(t.target.ownerDocument).unbind("mousemove", s).unbind("mouseup", r);
            ...
            h = u.blink,
            f = c.textareaSpan,
            p = c.textarea;c.blurred && (c.editable || a.prepend(f), p.focus()), n.preventDefault(), n.target.unselectable = !0, u.blink = t, c.seek(Dt(n.target), n.pageX, n.pageY).cursor.startSelection(), a.mousemove(i), Dt(n.target.ownerDocument).mousemove(s).mouseup(r);
      });
    };
  }), zt.open(function (t) {
    t.seek = function (t, e, n) {
      var i,
          r,
          o,
          a = this.notify("select").cursor;return t && (i = t.attr(xt) || t.attr(qt), i || (r = t.parent(), i = r.attr(xt) || r.attr(qt))), o = i ? St.byId[i] : this.root, s("nodeId is the id of some Node that exists", o), a.clearSelection().show(), o.seek(e, a), this.scrollHoriz(), this;
    };
  }), zt.open(function (t) {
    t.scrollHoriz = function () {
      var t,
          ...
          r = this.cursor,
          o = r.selection,
          a = this.root.jQ[0].getBoundingClientRect();if (o) if ((n = o.jQ[0].getBoundingClientRect(), i = n.left - (a.left + 20), s = n.right - (a.right - 20), o.ends[Tt] === r[Ct])) if (0 > i) e = i;else {
        if (!(s > 0)) return;e = n.left - s < a.left + 20 ? i : s;
      } else if (s > 0) e = s;else {
        if (!(0 > i)) return;e = n.right - i > a.right - 20 ? s : i;
      } else if ((t = r.jQ[0].getBoundingClientRect().left, t > a.right - 20)) e = t - (a.right - 20);else {
        if (!(t < a.left + 20)) return;e = t - (a.left + 20);
    ...
    Bt.p.substituteTextarea = function () {
      ...
      var t,
          ...
          n = this.options.substituteTextarea();if (!n.nodeType) throw "substituteTextarea() must return a DOM element, got " + n;n = this.textarea = Dt(n).appendTo(e), t = this, t.cursor.selectionChanged = function () {
        t.selectionChanged();
      }, t.container.bind("copy", function () {
        t.setTextareaSelection();
      });
    }, t.selectionChanged = function () {
      var t = this;X(t.container[0]), t.textareaSelectionTimeout === m && (t.textareaSelectionTimeout = setTimeout(function () {
        t.setTextareaSelection();
      }));
    }, t.setTextareaSelection = function () {
      this.textareaSelectionTimeout = m;var t = "";this.cursor.selection && (t = this.cursor.selection.join("latex"), this.options.statelessClipboard && (t = "$" + t + "$")), this.selectFn(t);
      ...
      function t() {
        s.detach(), e.blurred = !0;
          ...
          n = (e.root, e.cursor),
          i = e.textarea,
          s = e.textareaSpan;this.container.prepend('<span class="mq-selectable">$' + e.exportLatex() + "$</span>"), e.blurred = !0, i.bind("cut paste", !1).focus(function () {
        e.blurred = !1;
      }).blur(function () {
      ...
      var t = this,
          ...
          n = t.textarea,
          i = t.textareaSpan,
          s = q(n, this);this.selectFn = function (t) {
        s.select(t);
      ...
      if ("\n" === t) return this.handle("enter");var e = this.notify().cursor;e.parent.write(e, t), this.scrollHoriz();
    }, t.paste = function (t) {
    ...
    t.finalizeInsert = function (t, e) {
      var n = this;n.postOrder("finalizeTree", t), n.postOrder("contactWeld", e), n.postOrder("blur"), n.postOrder("reflow"), n[Ct].siblingCreated && n[Ct].siblingCreated(t, Tt), n[Tt].siblingCreated && n[Tt].siblingCreated(t, Ct), n.bubble("reflow");
    };
  }), O = Qt(y, function (t, e) {
    t.init = function (t, n, i) {
      var s = this;e.init.call(s), s.ctrlSeq || (s.ctrlSeq = t), n && (s.htmlTemplate = n), i && (s.textTemplate = i);
      ...
      var t = x.block,
          e = this;return t.times(e.numBlocks()).map(function (t) {
        e.blocks = t;for (var n = 0; n < t.length; n += 1) t[n].adopt(e, e.ends[Ct], 0);return e;
      });
    }, t.createLeftOf = function (t) {
      var n = this,
          i = n.replacedFragment;n.createBlocks(), e.createLeftOf.call(n, t), i && (i.adopt(n.ends[Tt], 0, 0), i.jQ.appendTo(n.ends[Tt].jQ)), n.finalizeInsert(t.options), n.placeCursor(t);
    }, t.createBlocks = function () {
      var t,
          e,
          n = this,
          i = n.numBlocks(),
          s = n.blocks = Array(i);for (t = 0; i > t; t += 1) e = s[t] = T(), e.adopt(n, n.ends[Ct], 0);
      ...
      var i = n && this[n + "Into"];e.insAtDirEnd(-t, i || this.ends[-t]);
      ...
      function n(t) {
        var e = {};return e[Tt] = t.jQ.offset().left, e[Ct] = e[Tt] + t.jQ.outerWidth(), e;
      }var i,
          s = this,
          r = n(s);return t < r[Tt] ? e.insLeftOf(s) : t > r[Ct] ? e.insRightOf(s) : (i = r[Tt], void s.eachChild(function (o) {
        var a = n(o);return t < a[Tt] ? (t - i < a[Tt] - t ? o[Tt] ? e.insAtRightEnd(o[Tt]) : e.insLeftOf(s) : e.insAtLeftEnd(o), !1) : t > a[Ct] ? void (o[Ct] ? i = a[Ct] : r[Ct] - t < t - a[Ct] ? e.insRightOf(s) : e.insAtRightEnd(o)) : (o.seek(t, e), !1);
      }));
      ...
      var t,
          ...
          a = i.htmlTemplate.match(/<[^<>]+>|[^<>]+/g);for (s("no unmatched angle brackets", a.join("") === this.htmlTemplate), t = 0, e = a[0]; e; t += 1, e = a[t]) if ("/>" === e.slice(-2)) a[t] = e.slice(0, -2) + o + "/>";else if ("<" === e.charAt(0)) {
        s("not an unmatched top-level close tag", "/" !== e.charAt(1)), a[t] = e.slice(0, -1) + o + ">", n = 1;do t += 1, e = a[t], s("no missing close tags", e), "</" === e.slice(0, 2) ? n -= 1 : "<" === e.charAt(0) && "/>" !== e.slice(-2) && (n += 1); while (n > 0);
      ...
      var t = this,
          e = 0;return t.foldChildren(t.textTemplate[e], function (n, i) {
        e += 1;var s = i.text();return n && "(" === t.textTemplate[e] && "(" === s[0] && ")" === s.slice(-1) ? n + s.slice(1, -1) + t.textTemplate[e] : n + i.text() + (t.textTemplate[e] || "");
      });
    };
  }), k = Qt(O, function (e, n) {
    ...
    t.join = function (t) {
      ...
      var i = n && this.parent[n + "Into"];!i && this[t] ? e.insAtDirEnd(-t, this[t]) : e.insDirOf(t, this.parent);
    }, t.selectOutOf = function (t, e) {
      e.insDirOf(t, this.parent);
    }, t.deleteOutOf = function (t, e) {
      e.unwrapGramp();
    }, t.seek = function (t, e) {
      var n = this.ends[Ct];if (!n || n.jQ.offset().left + n.jQ.outerWidth() < t) return e.insAtRightEnd(this);if (t < this.ends[Tt].jQ.offset().left) return e.insAtLeftEnd(this);for (; t < n.jQ.offset().left;) n = n[Tt];return n.seek(t, e);
    }, t.chToCmd = function (t) {
      var e;return t.match(/^[a-eg-zA-Z]$/) ? I(t) : /^\d$/.test(t) ? A(t) : (e = At[t] || Et[t]) ? e(t) : j(t);
    }, t.write = function (t, e) {
      var n = this.chToCmd(e);t.selection && n.replaces(t.replaceSelection()), n.createLeftOf(t.show());
    }, t.focus = function () {
    ...
    return Qt(t.AbstractMathQuill, function (e, n) {
      this.RootBlock = T, e.__mathquillify = function () {
        ...
        var e = n.latex.apply(this, arguments);return arguments.length > 0 && this.__controller.root.postOrder("registerInnerField", this.innerFields = [], t.MathField), e;
      };
    });
    ...
    function n(t) {
      var e, n;return t.jQ[0].normalize(), e = t.jQ[0].firstChild, s("only node in TextBlock span is Text node", 3 === e.nodeType), n = _(e.data), n.jQadd(e), t.children().disown(), n.adopt(t, 0, 0);
      ...
      var n,
          i = this;if ((e.createLeftOf.call(this, t), i[Ct].siblingCreated && i[Ct].siblingCreated(t.options, Tt), i[Tt].siblingCreated && i[Tt].siblingCreated(t.options, Ct), i.bubble("reflow"), t.insAtRightEnd(i), i.replacedText)) for (n = 0; n < i.replacedText.length; n += 1) i.write(t, i.replacedText.charAt(n));
    }, t.parser = function () {
      var t = this,
          e = w.string,
          n = w.regex,
          i = w.optWhitespace;return i.then(e("{")).then(n(/^[^}]*/)).skip(e("}")).map(function (e) {
    ...
    function n(t, e) {
      ...
      var e = _(this.text.slice(t)).adopt(this.parent, this, this[Ct]);return e.jQadd(this.dom.splitText(t)), this.text = this.text.slice(0, t), e;
    }, t.moveTowards = function (t, e) {
      var i, s;return r(t), i = n(-t, this.text), s = this[-t], s ? s.insTextAtDirEnd(i, t) : _(i).createDir(-t, e), this.deleteTowards(t, e);
    }, t.latex = function () {
      return this.text;
    }, t.deleteTowards = function (t, e) {
      ...
      var i, s, o, a;return r(t), i = e.anticursor, s = n(-t, this.text), i[t] === this ? (o = _(s).createDir(t, e), i[t] = o, e.insDirOf(t, o)) : (a = this[-t], a ? a.insTextAtDirEnd(s, t) : (o = _(s).createDir(-t, e), o.jQ.insDirOf(-t, e.selection.jQ)), 1 === this.text.length && i[-t] === this && (i[-t] = this[-t])), this.deleteTowards(t, e);
    };
    ...
    t.keystroke = function (t) {
      ...
      if ((t.show().deleteSelection(), "$" === e)) S(t).createLeftOf(t);else {
        var n;"<" === e ? n = "&lt;" : ">" === e && (n = "&gt;"), j(e, n).createLeftOf(t);
      }
    };
    ...
    t.ctrlSeq = "\\", t.replaces = function (t) {
      ...
      if ((e.createLeftOf.call(this, t), this._replacedFragment)) {
        var n = this.jQ[0];this.jQ = this._replacedFragment.jQ.addClass("mq-blur").bind("mousedown mousemove", function (t) {
    ...
    t.init = function (t, n) {
      ...
      var t = this.ctrlSeq;return !this[Tt] || this[Tt] instanceof R || this[Tt] instanceof Q || "\\ " === this[Tt].ctrlSeq || (t = "*" + t), !this[Ct] || this[Ct] instanceof Q || this[Ct] instanceof rt || (t += "*"), t;
    };
  }), Bt.p.autoCommands = { _maxLength: 0 }, Ft.autoCommands = function (t) {
    var e, n, i, s, r;if (!/^[a-z]+(?: [a-z]+)*$/i.test(t)) throw '"' + t + '" not a space-delimited list of only letters';for (e = t.split(" "), n = {}, i = 0, s = 0; s < e.length; s += 1) {
      if ((r = e[s], r.length < 2)) throw 'autocommand "' + r + '" not minimum length of 2';if (Et[r] === F) throw '"' + r + '" is a built-in operator name';n[r] = 1, i = Ot(i, r.length);
    ...
    function n(t) {
      ...
      var n,
          ...
          o = r._maxLength;if (o > 0) {
        for (n = this.letter, i = t[Tt], s = 1; i instanceof I && o > s;) n = i.letter + n, i = i[Tt], s += 1;for (; n.length;) {
          if (r.hasOwnProperty(n)) {
            for (s = 2, i = t[Tt]; s < n.length; s += 1, i = i[Tt]);return Lt(i, t[Tt]).remove(), t[Tt] = i[Tt], Et[n](n).createLeftOf(t);
          }n = n.slice(1);
        }
      ...
      var e,
          ...
          h,
          f,
          p = t.autoOperatorNames;if (0 !== p._maxLength) {
        for (e = this.letter, i = this[Tt]; i instanceof I; i = i[Tt]) e = i.letter + e;for (s = this[Ct]; s instanceof I; s = s[Ct]) e += s.letter;Lt(i[Ct] || this.parent.ends[Tt], s[Tt] || this.parent.ends[Ct]).each(function (t) {
          ...
          for (c = 0, u = o; a > c; c += 1, u = u[Ct]) u.italicize(!1), h = u;f = z.hasOwnProperty(l), o.ctrlSeq = (f ? "\\" : "\\operatorname{") + o.ctrlSeq, h.ctrlSeq += f ? " " : "}", B.hasOwnProperty(l) && h[Tt][Tt][Tt].jQ.addClass("mq-last"), n(o[Tt]) && o.jQ.addClass("mq-first"), n(h[Ct]) && h.jQ.addClass("mq-last"), r += a - 1, o = h;continue t;
        }
      }
    };
  }), z = {}, M = Bt.p.autoOperatorNames = { _maxLength: 9 }, B = { limsup: 1, liminf: 1, projlim: 1, injlim: 1 }, (function () {
    var t,
        e,
        n,
        i,
        s = "arg deg det dim exp gcd hom inf ker lg lim ln log max min sup limsup liminf injlim projlim Pr".split(" ");for (t = 0; t < s.length; t += 1) z[s[t]] = M[s[t]] = 1;for (e = "sin cos tan arcsin arccos arctan sinh cosh tanh sec csc cot coth".split(" "), t = 0; t < e.length; t += 1) z[e[t]] = 1;for (n = "sin cos tan sec cosec csc cotan cot ctg".split(" "), t = 0; t < n.length; t += 1) M[n[t]] = M["arc" + n[t]] = M[n[t] + "h"] = M["ar" + n[t] + "h"] = M["arc" + n[t] + "h"] = 1;for (i = "gcf hcf lcm proj span".split(" "), t = 0; t < i.length; t += 1) M[i[t]] = 1;
  })(), Ft.autoOperatorNames = function (t) {
    var e, n, i, s, r;if (!/^[a-z]+(?: [a-z]+)*$/i.test(t)) throw '"' + t + '" not a space-delimited list of only letters';for (e = t.split(" "), n = {}, i = 0, s = 0; s < e.length; s += 1) {
      if ((r = e[s], r.length < 2)) throw '"' + r + '" not minimum length of 2';n[r] = 1, i = Ot(i, r.length);
    }return n._maxLength = i, n;
  }, F = Qt(k, function (t, e) {
    t.init = function (t) {
      this.ctrlSeq = t;
      ...
      var e,
          n = this.ctrlSeq;for (e = 0; e < n.length; e += 1) I(n.charAt(e)).createLeftOf(t);
    }, t.parser = function () {
      var t,
          e = this.ctrlSeq,
          n = T();for (t = 0; t < e.length; t += 1) I(e.charAt(t)).adopt(n, n.ends[Ct], 0);return w.succeed(n.children());
    };
  });for ($ in M) M.hasOwnProperty($) && (Et[$] = F);Et.operatorname = Qt(O, function (e) {
    ...
    t.init = function (t) {
      ...
      var e = x.parse(this.latex);e.children().adopt(t.parent, t[Tt], t[Ct]), t[Tt] = e.ends[Ct], e.jQize().insertBefore(t.jQ), e.finalizeInsert(t.options, t), e.ends[Ct][Ct].siblingCreated && e.ends[Ct][Ct].siblingCreated(t.options, Tt), e.ends[Tt][Tt].siblingCreated && e.ends[Tt][Tt].siblingCreated(t.options, Ct), t.parent.bubble("reflow");
    }, t.parser = function () {
      var t = x.parse(this.latex).children();return w.succeed(t);
    };
    ...
    t.init = function (t, n) {
      this.data = t, this.strict = n;var i = n ? "Strict" : "";e.init.call(this, t["ctrlSeq" + i], t["html" + i], t["text" + i]);
    }, t.swap = function (t) {
      this.strict = t;var e = t ? "Strict" : "";this.ctrlSeq = this.data["ctrlSeq" + e], this.jQ.html(this.data["html" + e]), this.textTemplate = [this.data["text" + e]];
  ...
  }), H = { ctrlSeq: "\\le ", html: "&le;", text: "≤", ctrlSeqStrict: "<", htmlStrict: "&lt;", textStrict: "<" }, G = { ctrlSeq: "\\ge ", html: "&ge;", text: "≥", ctrlSeqStrict: ">", htmlStrict: "&gt;", textStrict: ">" }, Et["<"] = Et.lt = i(W, H, !0), Et[">"] = Et.gt = i(W, G, !0), Et["≤"] = Et.le = Et.leq = i(W, H, !1), Et["≥"] = Et.ge = Et.geq = i(W, G, !1), K = Qt(Q, function (t, e) {
    t.init = function () {
      e.init.call(this, "=", "=");
    }, t.createLeftOf = function (t) {
      return t[Tt] instanceof W && t[Tt].strict ? (t[Tt].swap(!1), void t[Tt].bubble("reflow")) : void e.createLeftOf.apply(this, arguments);
    };
  }), Et["="] = K, Et["×"] = Et.times = i(Q, "\\times ", "&times;", "[x]"), Et["÷"] = Et.div = Et.divide = Et.divides = i(Q, "\\div ", "&divide;", "[/]"), At["~"] = Et.sim = i(Q, "\\sim ", "~", "~"), X = t, Z = document.createElement("div"), V = Z.style, J = { transform: 1, WebkitTransform: 1, MozTransform: 1, OTransform: 1, msTransform: 1 };for (et in J) if (et in V) {
    tt = et;break;
  }tt ? Y = function (t, e, n) {
    t.css(tt, "scale(" + e + "," + n + ")");
    ...
    }var s, r;e /= 1 + (n - 1) / 2, t.css("fontSize", n + "em"), t.hasClass("mq-matrixed-container") || t.addClass("mq-matrixed-container").wrapInner('<span class="mq-matrixed"></span>'), s = t.children().css("filter", "progid:DXImageTransform.Microsoft.Matrix(M11=" + e + ",SizingMethod='auto expand')"), i(), r = setInterval(i), Dt(window).load(function () {
      clearTimeout(r), i();
    });
  }) : Y = function (t, e, n) {
    t.css("fontSize", n + "em");
    ...
    t.setColor = function (t) {
      ...
      var t = this,
          n = w.optWhitespace,
          i = w.string,
          s = w.regex;return n.then(i("{")).then(s(/^[#\w\s.,()%-]*/)).skip(i("}")).then(function (n) {
    ...
    t.parser = function () {
      var t = this,
          n = w.string,
          i = w.regex;return w.optWhitespace.then(n("{")).then(i(/^[-\w\s\\\xA0-\xFF]*/)).skip(n("}")).then(function (n) {
    ...
    t.ctrlSeq = "_{...}^{...}", t.createLeftOf = function (t) {
      ...
      var e, n, i, s, r, o;for (e = Tt; e; e = e === Tt ? Ct : !1) if (this[e] instanceof rt) {
        ...
        })(s, i));this.remove(), t && t[Tt] === this && (e === Ct && o ? o[Tt] ? t.insRightOf(o[Tt]) : t.insAtLeftEnd(o.parent) : t.insRightOf(this[e]));break;
      }this.respace();
    }, Bt.p.charsThatBreakOutOfSupSub = "", t.finalizeTree = function () {
      this.ends[Tt].write = function (t, e) {
        if (t.options.autoSubscriptNumerals && this === this.parent.sub) {
          if ("_" === e) return;var n = this.chToCmd(e);return n instanceof k ? t.deleteSelection() : t.clearSelection().insRightOf(this.parent), n.createLeftOf(t.show());
      ...
      if (n.options.autoSubscriptNumerals && this.sub) {
        var i = this.sub.ends[-t];i instanceof k ? i.remove() : i && i.deleteTowards(t, n.insAtDirEnd(-t, this.sub)), this.sub.isEmpty() && (this.sub.deleteOutOf(Tt, n.insAtLeftEnd(this.sub)), this.sup && n.insDirOf(-t, this));
      } else e.deleteTowards.apply(this, arguments);
    }, t.latex = function () {
      function t(t, e) {
        var n = e && e.latex();return e ? t + (1 === n.length ? n : "{" + (n || " ") + "}") : "";
    ...
    t.init = function (t, e) {
      var n = '<span class="mq-large-operator mq-non-leaf"><span class="mq-to"><span>&1</span></span><big>' + e + '</big><span class="mq-from"><span>&0</span></span></span>';k.prototype.init.call(this, t, n);
    }, t.createLeftOf = function (t) {
      ...
      var t,
          ...
          s = x.block,
          r = this,
          o = r.blocks = [T(), T()];for (t = 0; t < o.length; t += 1) o[t].adopt(r, r.ends[Ct], 0);return n.then(e("_").or(e("^"))).then(function (t) {
        var e = o["_" === t ? 0 : 1];return s.then(function (t) {
    ...
    e.createLeftOf = function (e) {
      if (!this.replacedFragment) {
        for (var i = e[Tt]; i && !(i instanceof Q || i instanceof (Et.text || t) || i instanceof ot || "\\ " === i.ctrlSeq || /^[,;:]$/.test(i.ctrlSeq));) i = i[Tt];i instanceof ot && i[Ct] instanceof rt && (i = i[Ct], i[Ct] instanceof rt && i[Ct].ctrlSeq != i.ctrlSeq && (i = i[Ct])), i !== e[Tt] && (this.replaces(Lt(i[Ct] || e.parent.ends[Tt], e[Tt])), e[Tt] = i);
    ...
    t.ctrlSeq = "\\sqrt", t.htmlTemplate = '<span class="mq-non-leaf"><span class="mq-scaled mq-sqrt-prefix">&radic;</span><span class="mq-non-leaf mq-sqrt-stem">&0</span></span>', t.textTemplate = ["sqrt(", ")"], t.parser = function () {
      return x.optBlock.then(function (t) {
        return x.block.map(function (e) {
          var n = ht();return n.blocks = [t, e], t.adopt(n, 0, 0), e.adopt(n, t, 0), n;
        });
      }).or(e.parser.call(this));
    }, t.reflow = function () {
      var t = this.ends[Ct].jQ;Y(t.prev(), 1, t.innerHeight() / +t.css("fontSize").slice(0, -2) - .1);
    };
    ...
    e.init = function (t, e, i, s, r) {
      n.init.call(this, "\\left" + s, m, [e, i]), this.side = t, this.sides = {}, this.sides[Tt] = { ch: e, ctrlSeq: s }, this.sides[Ct] = { ch: i, ctrlSeq: r };
    }, e.numBlocks = function () {
      return 1;
    }, e.html = function () {
      ...
      return e instanceof ft && e.side && e.side !== -n && ("|" === this.sides[this.side].ch || e.side === -this.side) && (!t.restrictMismatchedBrackets || pt[this.sides[this.side].ch] === e.sides[e.side].ch || ({ "(": "]", "[": ")" })[this.sides[Tt].ch] === e.sides[Ct].ch) && e;
      ...
      var i,
          ...
          o = this.parent,
          a = this[t],
          l = o.ends[t];if (t === this.side) return this.unwrap(), void (a ? n.insDirOf(-t, a) : n.insAtDirEnd(t, o));if ((i = n.options, s = !this.side, this.side = -t, this.oppBrack(i, this.ends[Tt].ends[this.side], t))) this.closeOpposing(this.ends[Tt].ends[this.side]), r = this.ends[Tt].ends[t], this.unwrap(), r.siblingCreated && r.siblingCreated(n.options, t), a ? n.insDirOf(-t, a) : n.insAtDirEnd(t, o);else {
        if (this.oppBrack(i, this.parent.parent, t)) this.parent.parent.closeOpposing(this), this.parent.parent.unwrap();else {
          if (e && s) return this.unwrap(), void (a ? n.insDirOf(-t, a) : n.insAtDirEnd(t, o));this.sides[t] = { ch: pt[this.sides[this.side].ch], ctrlSeq: pt[this.sides[this.side].ctrlSeq] }, this.delimjQs.removeClass("mq-ghost").eq(t === Tt ? 0 : 1).addClass("mq-ghost").html(this.sides[t].ch);
  ...
  }), pt = { "(": ")", ")": "(", "[": "]", "]": "[", "{": "}", "}": "{", "\\{": "\\}", "\\}": "\\{", "&lang;": "&rang;", "&rang;": "&lang;", "\\langle ": "\\rangle ", "\\rangle ": "\\langle ", "|": "|" }, d("("), d("["), d("{", "\\{"), Et.langle = i(ft, Tt, "&lang;", "&rang;", "\\langle ", "\\rangle "), Et.rangle = i(ft, Ct, "&lang;", "&rang;", "\\langle ", "\\rangle "), At["|"] = i(ft, Tt, "|", "|", "|", "|"), Et.left = Qt(O, function (t) {
    t.parser = function () {
      var t = w.regex,
          e = w.string,
          n = (w.succeed, w.optWhitespace);return n.then(t(/^(?:[([|]|\\\{)/)).then(function (i) {
        var s = "\\" === i.charAt(0) ? i.slice(1) : i;return x.then(function (r) {
          return e("\\right").skip(n).then(t(/^(?:[\])|]|\\\})/)).map(function (t) {
            var e = "\\" === t.charAt(0) ? t.slice(1) : t,
                n = ft(0, s, e, i, t);return n.blocks = [r], r.adopt(n, 0, 0), n;
          });
        });
      });
    };
    ...
    t.ctrlSeq = "\\MathQuillMathField", t.htmlTemplate = '<span class="mq-editable-field"><span class="mq-root-block">&0</span></span>', t.parser = function () {
      var t = this,
          n = w.string,
          i = w.regex,
          s = w.succeed;return n("[").then(i(/^[a-z][a-z0-9]*/i)).skip(n("]")).map(function (e) {
        t.name = e;
      }).or(s()).then(e.parser.call(t));
    }, t.finalizeTree = function () {
      var t = zt(this.ends[Tt], this.jQ, Bt());t.KIND_OF_MQ = "MathField", t.editable = !0, t.createTextarea(), t.editablesTextareaEvents(), t.cursor.insAtRightEnd(t.root), u(t.root);
    ...
    t.setOptions = function (t) {
      ...
      var t = this;return string = w.string, regex = w.regex, succeed = w.succeed, string("{").then(regex(/^[a-z][a-z0-9]*/i)).skip(string("}")).then(function (e) {
        return string("[").then(regex(/^[-\w\s]*/)).skip(string("]")).or(succeed()).map(function (n) {
          return t.setOptions(Nt[e](n));
        });
      });
    };
  }), bt = c(1);for (vt in bt) (function (t, e) {

...
var _modulesToTop = __webpack_require__(18);

$(function () {
    $('.bxslider').bxSlider();
    $('.dialog-wrapper .btn-close').click(function () {
        $('.dialog-wrapper').hide();
    });
    ...
    $('.rank-list .more').click(function () {
        var tlist = $('.rank-list .cont').eq(i).find('ul');
        var l = tlist.css('top');
        var tw = -parseInt(l) + 300;
